...
#HBEP = float(raw_input("Enter Head rise per stage at BEP (non-viscous service) in feet:"))
#QBEP = float(raw_input("Enter capacity at BEP (non-viscous service) in gpm: "))

inpfilename = raw_input("Input Filename with original data - US units: ")
...
pseudo = 1.95*(visco**0.5)*(0.04739*(HBEP**0.25739) *(QBEP**0.5))**0.5
...
fn.write(str(sg))
fn.write("\n")
fn.write("% BEP Capacity,Q[gpm], H[feet], Efficiency[%], Power[HP]")
